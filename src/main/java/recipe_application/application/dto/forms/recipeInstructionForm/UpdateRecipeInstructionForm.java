...
@Component
public class UpdateRecipeInstructionForm {
    ...
    public UpdateRecipeInstructionForm() {
    }

    public UpdateRecipeInstructionForm(Integer id, String title, String instruction) {
        this.id = id;
        this.title = title;
